    ...
    switch (activeTab) {
      ...
      case "properties":
        if (propertiesLoading)
          return <div className="card p-6">Loading properties...</div>;
        if (propertiesError)
          return (
            <div className="card p-6 text-danger-700">
              Failed to load properties.
            </div>
          );
        return <PropertyList properties={propertiesData || []} />;
      case "tenants":
        if (tenantsLoading)
          return <div className="card p-6">Loading tenants...</div>;
        if (tenantsError)
          return (
            <div className="card p-6 text-danger-700">
      ...
      case "leases":
        if (tenantsLoading)
          return <div className="card p-6">Loading leases...</div>;
        if (tenantsError)
          return (
            <div className="card p-6 text-danger-700">
      ...
      case "maintenance":
        if (maintenanceLoading)
          return <div className="card p-6">Loading maintenance...</div>;
        if (maintenanceError)
          return (
            <div className="card p-6 text-danger-700">
        ...
        return (
          <MaintenanceList
            requests={maintenanceData || mockMaintenanceRequests}
          />
        );
      case "payments":
        if (paymentsLoading)
          return <div className="card p-6">Loading payments...</div>;
        if (paymentsError)
          return (
            <div className="card p-6 text-danger-700">
