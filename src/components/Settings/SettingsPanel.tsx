...
export const SettingsPanel: React.FC = () => {
  ...
  const [settings, setSettings] = useState({
    profile: {
      firstName: 'Sarah',
      lastName: 'Johnson',
      email: 'sarah.johnson@propertypo.com',
      ...
      <div>
        ...
        <div className="space-y-4">
          {[
            ...
            { key: 'pushNotifications', label: 'Push Notifications', description: 'Receive push notifications in browser', icon: Smartphone },
            { key: 'maintenanceAlerts', label: 'Maintenance Alerts', description: 'Get notified about maintenance requests', icon: Bell },
            { key: 'paymentReminders', label: 'Payment Reminders', description: 'Reminders for overdue payments', icon: Bell },
            { key: 'leaseExpirations', label: 'Lease Expiration Alerts', description: 'Alerts for upcoming lease expirations', icon: Bell },
            { key: 'marketingEmails', label: 'Marketing Emails', description: 'Receive product updates and tips', icon: Mail },
          ].map((item) => {
      ...
      <div>
        ...
        <div className="space-y-4">
          <div className="p-4 bg-gray-50 rounded-xl">
            ...
            <p className="text-sm text-gray-600 mb-4">Download all your property management data</p>
            <button className="btn-primary">Export All Data</button>
          </div>
          
          <div className="p-4 bg-gray-50 rounded-xl">
            <h4 className="font-medium text-gray-900 mb-2">Backup Settings</h4>
            <p className="text-sm text-gray-600 mb-4">Automatic backups are enabled daily at 2:00 AM</p>
  ...
  return (
    <div className="page-enter space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold font-display gradient-text">Settings</h2>
