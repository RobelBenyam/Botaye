...
import { Plus, Search, AlertCircle, Clock, CheckCircle, XCircle, Wrench } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {filteredRequests.map((request) => {
          ...
          return (
            <div key={request.id} className="card hover:shadow-lg transition-shadow duration-300">
                ...
                <div className="flex items-start space-x-4 flex-1">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center space-x-6 text-sm text-gray-500">
                      ...
                      <span>Reported by: {getTenantName(request.tenantId)}</span>
